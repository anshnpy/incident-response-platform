/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv .\cloudflare-env.d.ts` (hash: 14bdf782103bed56aa75f5a4f6756ffb)
// Runtime types generated with workerd@1.20260828.1 2026-08-30 global_fetch_strictly_public
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	WAZUH_INDEXER: Fetcher;
	ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WAZUH_INDEXER_URL" | "WAZUH_INDEXER_USER" | "WAZUH_INDEXER_PASSWORD">> {}
}
